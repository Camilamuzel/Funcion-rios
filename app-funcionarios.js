...
const botaoFrontEnd = document.getElementById 
...
card.append( nome, foto, cargo) // adiciona informações no card antes de retornar

return card
}

function carregarFuncionarios(funcionarios) {
  const cards = funcionarios.map(criarCard) //argumento a ser adicionado depois, map organiza 
